...
public class Aggregate extends Operator {
    ...
    public void open() throws NoSuchElementException, DbException,
        ...
        // no grouping means there is no group by field type
        Type gbfieldtype = null;
        if (gfield != Aggregator.NO_GROUPING) {
            gbfieldtype = childTd.getFieldType(gfield);
        }
        // pick the aggregator based on the type of the aggregate column
        ...
        // push every tuple from the child into the aggregator
        while (child.hasNext()) {
