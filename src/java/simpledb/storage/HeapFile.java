...
public class HeapFile implements DbFile {
    ...
    public List<Page> insertTuple(TransactionId tid, Tuple t)
        ...
        // look for an existing page with an empty slot
